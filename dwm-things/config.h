...
static const char* volupcmd[] = {"amixer", "set", "Master", "5%+", "NULL"};      // up
static const char* voldncmd[] = {"amixer", "set", "Master", "5%-", "NULL"};      // down
static const char* volmutecmd[] = {"amixer", "set", "Master", "toggle", "NULL"}; // mute

// standard key names:   /usr/include/X11/keysymdef.h
// special key names:    /usr/include/X11/XF86keysym.h
...
static Key keys[] = {
	...
	//	ALT + `: swap tags 
	{ ALTKEY,						XK_grave,  view,     	   {0} },
	//  ALT + TAB: swap windows within a tag (add shift to go back)
	...
	{ MODKEY,						XK_F8,	   spawn,		   {.v = brightnessdncmd } },
	{ MODKEY,						XK_F9,	   spawn,		   {.v = brightnessupcmd } },

	// VOLUME BUTTON CONTROLS (up/dn/mute)
